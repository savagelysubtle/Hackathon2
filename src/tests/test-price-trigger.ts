...
class MockPriceFetcher {
  ...
  setMockPrice(pair: string, price: number): void {
...
async function testPriceTrigger() {
  ...
  const solTrigger = new PriceTrigger(mockOracle as any, mockExecutor as any, {
    asset: 'SOL',
    baselinePrice: 200,
    triggerPercent: 15,
  ...
  const ethTrigger = new PriceTrigger(mockOracle as any, mockExecutor as any, {
    asset: 'ETH',
    baselinePrice: 3000,
    triggerPercent: 10,
    actionPercent: 5,
  ...
  console.log('═══════════════════════════════════════════════════');
  console.log(
    `   SOL Trigger: ${solTrigger.isTriggered() ? '🔥 Fired' : '⏳ Waiting'}`,
  );
  console.log(
    `   ETH Trigger: ${ethTrigger.isTriggered() ? '🔥 Fired' : '⏳ Waiting'}`,
  );
  console.log('═══════════════════════════════════════════════════\n');
